...
# toy_network_ex3 <- tibble(Source = c("P", "N1", "M1", "N2", "M2"),
#                        Effect = c(1, 1, -1, 1, 1),
...
#
# toy_measurements_ex3 <- tibble(M1 = c(1, -1),
#                             M2 = c(-1, 1))
#
# toy_input_ex3 <- tibble(P = c(1, 1))
...
@
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{mulT.png}}
