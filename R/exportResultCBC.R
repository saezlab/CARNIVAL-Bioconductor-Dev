...
exportResultCBC <- function(cplexSolutionFileName = cplexSolutionFileName, 
  ...
  for(ii in 2:ncol(solMatrix)){
    ...
    if(length(kk1) > 0){
      ...
      for(i in 1:length(kk1)){
        ...
        if(round(as.numeric(edgesUp[kk1[i], 2]))==as.numeric(
          nodesUp[which(
    ...
    if(length(kk1) > 0){
      ...
      for(i in 1:length(kk1)){
        ...
        if(round(as.numeric(edgesDown[kk1[i], 2]))==as.numeric(
          nodesDown[which(
